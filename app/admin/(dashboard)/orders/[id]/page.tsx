// 'use client' notes intentionally omitted at top-level of this file — see original comments below.
    ...
    <div className="space-y-6" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <ShiprocketPanel
            orderId={order.id}
            initialShiprocketOrderId={rawOrder.shiprocket_order_id || null}
            initialAwbCode={rawOrder.awb_code || null}
            initialCourierName={rawOrder.courier_name || null}
            initialShiprocketStatus={rawOrder.shiprocket_status || null}
          />
