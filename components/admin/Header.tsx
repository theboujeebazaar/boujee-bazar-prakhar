  ...
  return (
    <header className="h-16 bg-white border-b border-stone-200 flex items-center justify-between px-6 shrink-0">
      <div className="flex items-center gap-4">
        ...
        <a
          href="/"
          className="text-xs font-semibold !text-[#C8AA78] hover:!text-[#C8AA78] border border-[#C8AA78]/20 hover:border-[#C8AA78]/50 bg-[#C8AA78]/10 hover:bg-[#C8AA78]/20 px-3.5 py-1 rounded-full transition-all flex items-center gap-1 shadow-sm"
        >
